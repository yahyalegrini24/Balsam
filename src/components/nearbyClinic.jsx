...
import Icon from 'react-native-vector-icons/Ionicons'; // Import Icon library for the arrow icon
...
export default function NearbyClinic() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <TouchableOpacity style={styles.seeAllButton} onPress={() => navigation.navigate('NearbyClinic')}>
